    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-pink-50 px-4">
      <Card className="w-full max-w-md shadow-2xl border-t-4 border-t-indigo-600">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-extrabold text-indigo-900 text-center">Welcome back!</CardTitle>
        ...
        <CardContent>
          <form action={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-indigo-900 font-semibold">Email Address</Label>
              <Input
                id="email"
                name="email"
                type="email"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-indigo-900 font-semibold">Password</Label>
              </div>
              <Input
                id="password"
                name="password"
