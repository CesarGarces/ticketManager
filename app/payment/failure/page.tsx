    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="max-w-xl w-full shadow-2xl border-t-8 border-t-red-500 overflow-hidden">
        <div className="bg-red-50 p-10 text-center border-b">
          ...
          <p className="text-red-700">Something went wrong with your transaction. Your card has not been charged.</p>
        </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <span>Check your connection and try again in a few minutes.</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>Make sure your credit card has enough balance and is enabled for online payments.</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>Try using a different payment method in MercadoPago.</span>
                </li>
              </ul>
            </div>
